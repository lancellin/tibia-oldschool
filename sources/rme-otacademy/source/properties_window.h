...
protected:
	// Simple pane
	wxSpinCtrl* actionIdField = nullptr;
	wxSpinCtrl* uniqueIdField = nullptr;
	wxSpinCtrl* teleportDestinationXField = nullptr;
	wxSpinCtrl* teleportDestinationYField = nullptr;
	wxSpinCtrl* teleportDestinationZField = nullptr;
