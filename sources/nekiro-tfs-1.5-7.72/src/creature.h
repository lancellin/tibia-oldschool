...
class Creature : virtual public Thing
{
	...
	public:
		...
		virtual int32_t getDefenseReduction(Creature* attacker, CombatType_t combatType) const;
		virtual int32_t getArmorReduction(Creature* attacker, CombatType_t combatType) const;
