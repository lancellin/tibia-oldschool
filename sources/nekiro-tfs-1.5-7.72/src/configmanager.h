...
class ConfigManager
{
	public:
		...
		enum boolean_config_t {
			...
			PLAYER_CONSOLE_LOGS,
			FLOOR_PERSISTENCE_SHADOW_ENABLED,
			PLAYER_IO_SERVICE_ENABLED,
			SPECTATOR_CACHE_METRICS,
			SPECTATOR_CACHE_REGIONAL_INVALIDATION,
			SPECTATOR_CACHE_SHADOW_VALIDATE,
		...
		enum integer_config_t {
			...
			DEPOT_PREMIUM_LIMIT,
			IP_NUM,
			FLOOR_PERSISTENCE_WORLD_ID,
			FLOOR_PERSISTENCE_GENERATION_ID,
			FLOOR_PERSISTENCE_SNAPSHOT_DEBOUNCE_MS,
			FLOOR_PERSISTENCE_SNAPSHOT_MAX_DELAY_MS,
			FLOOR_PERSISTENCE_SNAPSHOT_RETRY_MS,
			FLOOR_PERSISTENCE_SNAPSHOT_BATCH_SIZE,
			PLAYER_IO_SERVICE_PORT,
