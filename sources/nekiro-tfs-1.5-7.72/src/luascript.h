...
class LuaScriptInterface
{
	...
	private:
		...
		static int luaGameSetFloorDirtyTrackingEnabled(lua_State* L);
		static int luaGameIsFloorDirtyTrackingEnabled(lua_State* L);
		static int luaGameSetFloorPersistenceCityPosition(lua_State* L);
		static int luaGameClearFloorPersistenceCityPositions(lua_State* L);
		static int luaGameIsFloorPersistenceCityPosition(lua_State* L);
		static int luaGameGetFloorDirtyStats(lua_State* L);
		static int luaGameGetFloorDirtyTile(lua_State* L);
		static int luaGameGetFloorDirtyTiles(lua_State* L);
		static int luaGameClearFloorDirtyTile(lua_State* L);
		static int luaGameClearFloorDirtyTiles(lua_State* L);
		static int luaGameGetFloorSnapshotStats(lua_State* L);
		static int luaGameGetFloorRecoveryPlan(lua_State* L);
		static int luaGameApplyFloorRecovery(lua_State* L);
		static int luaGameConfirmFloorRecovery(lua_State* L);
		static int luaGameVerifyFloorSnapshot(lua_State* L);
		static int luaGameInspectFloorInstanceId(lua_State* L);
		static int luaGameFlushFloorSnapshots(lua_State* L);
		static int luaGameSimulateFloorSnapshotFailures(lua_State* L);
		static int luaGameBeginFloorPersistenceCleanSave(lua_State* L);
		static int luaGameActivateEmergency(lua_State* L);
		static int luaGameFinishEmergency(lua_State* L);
		static int luaGameIsEmergencyActive(lua_State* L);
		static int luaGameGetSpawnPlayerBucket(lua_State* L);
		static int luaGameIsSpawnPlayerBucketOverridden(lua_State* L);
		static int luaGameSetSpawnPlayerBucketOverride(lua_State* L);
		static int luaGameClearSpawnPlayerBucketOverride(lua_State* L);
		static int luaGameIsSpawnRateBoostActive(lua_State* L);
		static int luaGameGetSpawnRateBoostRemainingSeconds(lua_State* L);
		static int luaGameGetSpawnRateBoostExpiresAt(lua_State* L);
		static int luaGameAddSpawnRateBoostDuration(lua_State* L);
		...
		static int luaItemGetLastActorGuid(lua_State* L);
		...
		static int luaItemGetFloorPersistenceInstanceId(lua_State* L);
		static int luaItemEnsureFloorPersistenceInstanceId(lua_State* L);
		static int luaItemEnsureFloorPersistenceSubtreeIdentified(lua_State* L);
		...
		static int luaPlayerGetCharmState(lua_State* L);
		static int luaPlayerActivateCharm(lua_State* L);
		static int luaPlayerSendCharmData(lua_State* L);
		...
		static int luaPlayerStartPlayerShop(lua_State* L);
