...
inline constexpr char ITEM_CUSTOM_ATTRIBUTE_LOOT_UNOPENED[] = "loot_unopened";
inline constexpr char ITEM_CUSTOM_ATTRIBUTE_LOOT_MONSTER_NAME[] = "loot_monster_name";
inline constexpr char ITEM_CUSTOM_ATTRIBUTE_LOOT_DIFFICULTY[] = "loot_difficulty";
inline constexpr char ITEM_CUSTOM_ATTRIBUTE_CREATURE_STACK[] = "creaturestack";
inline constexpr char ITEM_CUSTOM_ATTRIBUTE_ELITE_TIER[] = "elite_tier";
inline constexpr char ITEM_CUSTOM_ATTRIBUTE_ELITE_PORTAL[] = "elite_portal";
inline constexpr char ITEM_CUSTOM_ATTRIBUTE_FLOOR_INSTANCE_ID[] = "floor_persistence_instance_id";
inline constexpr char ITEM_CUSTOM_ATTRIBUTE_FLOOR_LAST_ACTOR_GUID[] = "floor_last_actor_guid";
inline constexpr char ITEM_CUSTOM_ATTRIBUTE_FLOOR_DEATH_BUNDLE[] = "floor_persistence_death_bundle";
inline constexpr char ITEM_CUSTOM_ATTRIBUTE_FLOOR_PLAYER_CORPSE[] = "floor_persistence_player_corpse";
inline constexpr char ITEM_CUSTOM_ATTRIBUTE_FLOOR_CREATURE_CORPSE[] = "floor_persistence_creature_corpse";
#include "items.h"
#include "luascript.h"
#include "tools.h"
#include <typeinfo>
...
enum AttrTypes_t {
	...
	ATTR_LAST_ACTOR_GUID = 39,
	ATTR_LAST_ACTOR_CONSISTENT = 40,
};
...
class ItemAttributes
{
	...
	private:
		...
		const CustomAttributeMap* getCustomAttributeMap() const {
			...
			const Attribute* attribute = getExistingAttr(ITEM_ATTRIBUTE_CUSTOM);
			return attribute ? attribute->value.custom : nullptr;
		}
		...
		const static uint32_t intAttributeTypes = ITEM_ATTRIBUTE_ACTIONID | ITEM_ATTRIBUTE_UNIQUEID | ITEM_ATTRIBUTE_DATE
			...
			| ITEM_ATTRIBUTE_ATTACK_SPEED | ITEM_ATTRIBUTE_LASTACTORGUID | ITEM_ATTRIBUTE_LASTACTORCONSISTENT;
...
class Item : virtual public Thing
{
	public:
		...
		bool isFloorPersistenceInstanceEligible() const;
		bool isFloorPersistenceIdentityReady() const;
		bool isFloorPersistenceSubtreeReady() const;
		bool isFloorPersistenceCreatureCorpse() const;
		std::string getFloorPersistenceInstanceId() const;
		uint32_t getFloorPersistenceLastActorGuid() const;
		bool setFloorPersistenceLastActorGuid(uint32_t playerGuid);
		bool hasFloorPersistenceLastActorConsistentSubtree() const;
		void setFloorPersistenceLastActorConsistentSubtree(bool consistent);
		bool ensureFloorPersistenceInstanceId(std::string& instanceId);
		void markAsPlayerMovedForFloorPersistence();
		void markFloorPersistenceAttributeDirty(bool explicitPlayerAction = false) const;
		...
		void setLoadedFromMapRecursively(bool value);
