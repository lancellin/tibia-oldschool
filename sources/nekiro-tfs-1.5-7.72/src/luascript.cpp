...
namespace {
	void pushFloorDirtyTileRecord(lua_State* L, const Position& position, const FloorDirtyTileRecord& record)
	{
		...
		lua_setfield(L, -2, "z");
		lua_pushnumber(L, static_cast<lua_Number>(record.eventCount));
		lua_setfield(L, -2, "eventCount");
		lua_pushnumber(L, static_cast<lua_Number>(record.firstSequence));
		lua_setfield(L, -2, "firstSequence");
		lua_pushnumber(L, static_cast<lua_Number>(record.lastSequence));
		lua_setfield(L, -2, "lastSequence");
		lua_pushnumber(L, static_cast<lua_Number>(record.firstModifiedAt));
		lua_setfield(L, -2, "firstModifiedAt");
		lua_pushnumber(L, static_cast<lua_Number>(record.lastModifiedAt));
		lua_setfield(L, -2, "lastModifiedAt");
		lua_pushnumber(L, record.reasonMask);
		lua_setfield(L, -2, "reasonMask");
		lua_pushnumber(L, record.lastReason);
		lua_setfield(L, -2, "lastReason");
		lua_pushnumber(L, record.originMask);
		lua_setfield(L, -2, "originMask");
		lua_pushnumber(L, record.lastOrigin);
		lua_setfield(L, -2, "lastOrigin");
		lua_pushnumber(L, static_cast<lua_Number>(record.tileVersion));
		lua_setfield(L, -2, "tileVersion");
		lua_pushboolean(L, record.snapshotInFlight);
		lua_setfield(L, -2, "snapshotInFlight");
		lua_pushnumber(L, static_cast<lua_Number>(record.snapshotVersionInFlight));
		lua_setfield(L, -2, "snapshotVersionInFlight");
		lua_pushnumber(L, record.snapshotRetryCount);
		lua_setfield(L, -2, "snapshotRetryCount");
		lua_pushnumber(L, static_cast<lua_Number>(record.snapshotRetryNotBefore));
		lua_setfield(L, -2, "snapshotRetryNotBefore");
		LuaScriptInterface::pushString(L, record.lastSnapshotError);
		lua_setfield(L, -2, "lastSnapshotError");
	}
}
...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnumIn("configKeys", ConfigManager::RATE_SPAWN_TIME)
	...
	registerMethod("Game", "setFloorDirtyTrackingEnabled", LuaScriptInterface::luaGameSetFloorDirtyTrackingEnabled);
	registerMethod("Game", "isFloorDirtyTrackingEnabled", LuaScriptInterface::luaGameIsFloorDirtyTrackingEnabled);
	registerMethod("Game", "setFloorPersistenceCityPosition", LuaScriptInterface::luaGameSetFloorPersistenceCityPosition);
	registerMethod("Game", "clearFloorPersistenceCityPositions", LuaScriptInterface::luaGameClearFloorPersistenceCityPositions);
	registerMethod("Game", "isFloorPersistenceCityPosition", LuaScriptInterface::luaGameIsFloorPersistenceCityPosition);
	registerMethod("Game", "getFloorDirtyStats", LuaScriptInterface::luaGameGetFloorDirtyStats);
	registerMethod("Game", "getFloorDirtyTile", LuaScriptInterface::luaGameGetFloorDirtyTile);
	registerMethod("Game", "getFloorDirtyTiles", LuaScriptInterface::luaGameGetFloorDirtyTiles);
	registerMethod("Game", "clearFloorDirtyTile", LuaScriptInterface::luaGameClearFloorDirtyTile);
	registerMethod("Game", "clearFloorDirtyTiles", LuaScriptInterface::luaGameClearFloorDirtyTiles);
	registerMethod("Game", "getFloorSnapshotStats", LuaScriptInterface::luaGameGetFloorSnapshotStats);
	registerMethod("Game", "getFloorRecoveryPlan", LuaScriptInterface::luaGameGetFloorRecoveryPlan);
	registerMethod("Game", "applyFloorRecovery", LuaScriptInterface::luaGameApplyFloorRecovery);
	registerMethod("Game", "confirmFloorRecovery", LuaScriptInterface::luaGameConfirmFloorRecovery);
	registerMethod("Game", "verifyFloorSnapshot", LuaScriptInterface::luaGameVerifyFloorSnapshot);
	registerMethod("Game", "inspectFloorInstanceId", LuaScriptInterface::luaGameInspectFloorInstanceId);
	registerMethod("Game", "flushFloorSnapshots", LuaScriptInterface::luaGameFlushFloorSnapshots);
	registerMethod("Game", "simulateFloorSnapshotFailures", LuaScriptInterface::luaGameSimulateFloorSnapshotFailures);
	registerMethod("Game", "beginFloorPersistenceCleanSave", LuaScriptInterface::luaGameBeginFloorPersistenceCleanSave);
	registerMethod("Game", "activateEmergency", LuaScriptInterface::luaGameActivateEmergency);
	registerMethod("Game", "finishEmergency", LuaScriptInterface::luaGameFinishEmergency);
	registerMethod("Game", "isEmergencyActive", LuaScriptInterface::luaGameIsEmergencyActive);
	registerMethod("Game", "getSpawnPlayerBucket", LuaScriptInterface::luaGameGetSpawnPlayerBucket);
	registerMethod("Game", "isSpawnPlayerBucketOverridden", LuaScriptInterface::luaGameIsSpawnPlayerBucketOverridden);
	registerMethod("Game", "setSpawnPlayerBucketOverride", LuaScriptInterface::luaGameSetSpawnPlayerBucketOverride);
	registerMethod("Game", "clearSpawnPlayerBucketOverride", LuaScriptInterface::luaGameClearSpawnPlayerBucketOverride);
	registerMethod("Game", "isSpawnRateBoostActive", LuaScriptInterface::luaGameIsSpawnRateBoostActive);
	registerMethod("Game", "getSpawnRateBoostRemainingSeconds", LuaScriptInterface::luaGameGetSpawnRateBoostRemainingSeconds);
	registerMethod("Game", "getSpawnRateBoostExpiresAt", LuaScriptInterface::luaGameGetSpawnRateBoostExpiresAt);
	registerMethod("Game", "addSpawnRateBoostDuration", LuaScriptInterface::luaGameAddSpawnRateBoostDuration);
	...
	registerMethod("Item", "getLastActorGuid", LuaScriptInterface::luaItemGetLastActorGuid);
	...
	registerMethod("Item", "getFloorPersistenceInstanceId", LuaScriptInterface::luaItemGetFloorPersistenceInstanceId);
	registerMethod("Item", "ensureFloorPersistenceInstanceId", LuaScriptInterface::luaItemEnsureFloorPersistenceInstanceId);
	registerMethod("Item", "ensureFloorPersistenceSubtreeIdentified", LuaScriptInterface::luaItemEnsureFloorPersistenceSubtreeIdentified);
	...
	registerMethod("Player", "getCharmState", LuaScriptInterface::luaPlayerGetCharmState);
	registerMethod("Player", "activateCharm", LuaScriptInterface::luaPlayerActivateCharm);
	registerMethod("Player", "sendCharmData", LuaScriptInterface::luaPlayerSendCharmData);
	...
	registerMethod("Player", "startPlayerShop", LuaScriptInterface::luaPlayerStartPlayerShop);
...
{
	pushBoolean(L, g_game.saveGameState());
	return 1;
}
...
int LuaScriptInterface::luaGameSetFloorDirtyTrackingEnabled(lua_State* L)
{
	// Game.setFloorDirtyTrackingEnabled(enabled)
	g_game.setFloorDirtyTrackingEnabled(getBoolean(L, 1, false));
	return 0;
}

int LuaScriptInterface::luaGameIsFloorDirtyTrackingEnabled(lua_State* L)
{
	// Game.isFloorDirtyTrackingEnabled()
	pushBoolean(L, g_game.isFloorDirtyTrackingEnabled());
	return 1;
}

int LuaScriptInterface::luaGameSetFloorPersistenceCityPosition(lua_State* L)
{
	// Game.setFloorPersistenceCityPosition(position[, excluded = true])
	g_game.setFloorPersistenceCityPosition(getPosition(L, 1), getBoolean(L, 2, true));
	return 0;
}

int LuaScriptInterface::luaGameClearFloorPersistenceCityPositions(lua_State*)
{
	// Game.clearFloorPersistenceCityPositions()
	g_game.clearFloorPersistenceCityPositions();
	return 0;
}

int LuaScriptInterface::luaGameIsFloorPersistenceCityPosition(lua_State* L)
{
	// Game.isFloorPersistenceCityPosition(position)
	pushBoolean(L, g_game.isFloorPersistenceCityPosition(getPosition(L, 1)));
	return 1;
}

int LuaScriptInterface::luaGameGetFloorDirtyStats(lua_State* L)
{
	// Game.getFloorDirtyStats()
	lua_createtable(L, 0, 6);
	pushBoolean(L, g_game.isFloorDirtyTrackingEnabled());
	lua_setfield(L, -2, "enabled");
	setField(L, "tileCount", static_cast<uint64_t>(g_game.getFloorDirtyTileCount()));
	setField(L, "sequence", g_game.getFloorDirtySequence());
	setField(L, "totalEvents", g_game.getFloorDirtyTotalEvents());
	setField(L, "ignoredSystemEvents", g_game.getFloorDirtyIgnoredSystemEvents());
	setField(L, "cityPositionCount", static_cast<uint64_t>(g_game.getFloorPersistenceCityPositionCount()));
	return 1;
}

int LuaScriptInterface::luaGameGetFloorDirtyTile(lua_State* L)
{
	// Game.getFloorDirtyTile(position)
	const Position& position = getPosition(L, 1);
	const FloorDirtyTileRecord* record = g_game.getFloorDirtyTile(position);
	if (!record) {
		lua_pushnil(L);
	} else {
		pushFloorDirtyTileRecord(L, position, *record);
	}
	return 1;
}

int LuaScriptInterface::luaGameGetFloorDirtyTiles(lua_State* L)
{
	// Game.getFloorDirtyTiles([limit = 20])
	const uint32_t limit = std::min<uint32_t>(getNumber<uint32_t>(L, 1, 20), 100);
	using DirtyEntry = std::pair<Position, const FloorDirtyTileRecord*>;
	std::vector<DirtyEntry> entries;
	entries.reserve(g_game.getFloorDirtyTileCount());
	for (const auto& entry : g_game.getFloorDirtyTiles()) {
		entries.emplace_back(entry.first, &entry.second);
	}

	std::sort(entries.begin(), entries.end(), [](const DirtyEntry& left, const DirtyEntry& right) {
		return left.second->lastSequence > right.second->lastSequence;
	});

	const size_t resultCount = std::min<size_t>(entries.size(), limit);
	lua_createtable(L, resultCount, 0);
	for (size_t index = 0; index < resultCount; ++index) {
		pushFloorDirtyTileRecord(L, entries[index].first, *entries[index].second);
		lua_rawseti(L, -2, index + 1);
	}
	return 1;
}

int LuaScriptInterface::luaGameClearFloorDirtyTile(lua_State* L)
{
	// Game.clearFloorDirtyTile(position)
	pushBoolean(L, g_game.clearFloorDirtyTile(getPosition(L, 1)));
	return 1;
}

int LuaScriptInterface::luaGameClearFloorDirtyTiles(lua_State* L)
{
	// Game.clearFloorDirtyTiles()
	lua_pushnumber(L, g_game.clearFloorDirtyTiles());
	return 1;
}

int LuaScriptInterface::luaGameGetFloorSnapshotStats(lua_State* L)
{
	// Game.getFloorSnapshotStats()
	const FloorSnapshotStats& runtime = g_game.getFloorSnapshotStats();
	const FloorSnapshotDatabaseStats database = g_game.getFloorSnapshotDatabaseStats();
	lua_createtable(L, 0, 36);
	pushBoolean(L, g_game.isFloorSnapshotShadowEnabled());
	lua_setfield(L, -2, "enabled");
	setField(L, "worldId", g_game.getFloorSnapshotWorldId());
	setField(L, "generationId", g_game.getFloorSnapshotGenerationId());
	setField(L, "policyVersion", FLOOR_SNAPSHOT_POLICY_VERSION);
	setField(L, "dirtyTiles", static_cast<uint64_t>(g_game.getFloorDirtyTileCount()));
	setField(L, "inFlight", g_game.getFloorSnapshotInFlightCount());
	setField(L, "queued", runtime.queued);
	setField(L, "succeeded", runtime.succeeded);
	setField(L, "failed", runtime.failed);
	setField(L, "serializationFailed", runtime.serializationFailed);
	setField(L, "staleCompletions", runtime.staleCompletions);
	setField(L, "totalSerializedBytes", runtime.totalSerializedBytes);
	setField(L, "totalSerializationMicros", runtime.totalSerializationMicros);
	setField(L, "lastSerializationMicros", runtime.lastSerializationMicros);
	setField(L, "checkpointGroups", static_cast<uint64_t>(g_game.getFloorCheckpointGroupCount()));
	setField(L, "checkpointGroupsCreated", runtime.checkpointGroupsCreated);
	setField(L, "checkpointGroupsMerged", runtime.checkpointGroupsMerged);
	setField(L, "checkpointGroupsSucceeded", runtime.checkpointGroupsSucceeded);
	setField(L, "checkpointGroupsFailed", runtime.checkpointGroupsFailed);
	...
	setField(L, "lastError", runtime.lastError);
	setField(L, "simulatedFailuresRemaining", g_game.getFloorSnapshotSimulatedFailures());
	pushBoolean(L, database.available);
	lua_setfield(L, -2, "databaseAvailable");
	setField(L, "databaseRows", database.rowCount);
	setField(L, "databaseBytes", database.totalBytes);
	setField(L, "databaseMaxTileVersion", database.maxTileVersion);
	setField(L, "databaseLastUpdatedAt", database.lastUpdatedAt);
	setField(L, "databaseError", database.error);
	return 1;
}

int LuaScriptInterface::luaGameGetFloorRecoveryPlan(lua_State* L)
{
	// Game.getFloorRecoveryPlan()
	const FloorRecoveryPlan& plan = g_game.getFloorRecoveryPlan();
	lua_createtable(L, 0, 140);
	pushBoolean(L, plan.evaluated);
	lua_setfield(L, -2, "evaluated");
	pushBoolean(L, plan.databaseAvailable);
	lua_setfield(L, -2, "databaseAvailable");
	pushBoolean(L, plan.replayEnabled);
	lua_setfield(L, -2, "replayEnabled");
	pushBoolean(L, plan.applyEnabled);
	lua_setfield(L, -2, "applyEnabled");
	setField(L, "mode", plan.mode);
	setField(L, "sourceState", plan.sourceState);
	setField(L, "sourceError", plan.sourceError);
	setField(L, "reason", plan.reason);
	setField(L, "validationError", plan.validationError);
	setField(L, "newestSessionId", plan.newestSessionId);
	setField(L, "sourceSessionId", plan.sourceSessionId);
	setField(L, "ignoredEmptySessions", plan.ignoredEmptySessions);
	setField(L, "sourcePlayerCount", plan.sourcePlayerCount);
	setField(L, "sourceTileCount", plan.sourceTileCount);
	setField(L, "sourceSessionSnapshotRows", plan.sourceSessionSnapshotRows);
	setField(L, "sourceCheckpointCount", plan.sourceCheckpointCount);
	setField(L, "sourceCommittedCheckpointCount", plan.sourceCommittedCheckpointCount);
	setField(L, "sourceCleanCheckpointCount", plan.sourceCleanCheckpointCount);
	setField(L, "sourceCleanCheckpointTileCount", plan.sourceCleanCheckpointTileCount);
	setField(L, "snapshotRows", plan.snapshotRows);
	setField(L, "validRows", plan.validRows);
	setField(L, "invalidRows", plan.invalidRows);
	setField(L, "itemCount", plan.itemCount);
	setField(L, "topItemCount", plan.topItemCount);
	setField(L, "serializedBytes", plan.serializedBytes);
	setField(L, "cityFilteredRows", plan.cityFilteredRows);
	setField(L, "deathBundleCount", plan.deathBundleCount);
	setField(L, "playerCorpseCount", plan.playerCorpseCount);
	setField(L, "identityMissingCount", plan.identityMissingCount);
	setField(L, "identityInvalidCount", plan.identityInvalidCount);
	setField(L, "formatMismatchRows", plan.formatMismatchRows);
	setField(L, "policyMismatchRows", plan.policyMismatchRows);
	setField(L, "sizeMismatchRows", plan.sizeMismatchRows);
	setField(L, "checksumMismatchRows", plan.checksumMismatchRows);
	setField(L, "blobInvalidRows", plan.blobInvalidRows);
	setField(L, "counterMismatchRows", plan.counterMismatchRows);
	setField(L, "identityProblemRows", plan.identityProblemRows);
	setField(L, "validationMicros", plan.validationMicros);
	pushBoolean(L, plan.dryRunEvaluated);
	lua_setfield(L, -2, "dryRunEvaluated");
	pushBoolean(L, plan.dryRunReady);
	lua_setfield(L, -2, "dryRunReady");
	setField(L, "dryRunRows", plan.dryRunRows);
	setField(L, "dryRunItemCount", plan.dryRunItemCount);
	setField(L, "dryRunTopItemCount", plan.dryRunTopItemCount);
	setField(L, "dryRunRestoreItemCount", plan.dryRunRestoreItemCount);
	setField(L, "dryRunQuarantineItemCount", plan.dryRunQuarantineItemCount);
	setField(L, "dryRunRejectedItemCount", plan.dryRunRejectedItemCount);
	setField(L, "dryRunRestoreTopItemCount", plan.dryRunRestoreTopItemCount);
	setField(L, "dryRunQuarantineTopItemCount", plan.dryRunQuarantineTopItemCount);
	setField(L, "dryRunRejectedTopItemCount", plan.dryRunRejectedTopItemCount);
	setField(L, "dryRunPersistAlwaysCount", plan.dryRunPersistAlwaysCount);
	setField(L, "dryRunPersistCleanOnlyCount", plan.dryRunPersistCleanOnlyCount);
	setField(L, "dryRunPersistFoodCount", plan.dryRunPersistFoodCount);
	setField(L, "dryRunDeathBundleCount", plan.dryRunDeathBundleCount);
	setField(L, "dryRunContainerCount", plan.dryRunContainerCount);
	setField(L, "dryRunIdentityCount", plan.dryRunIdentityCount);
	setField(L, "dryRunDuplicateIdentityCount", plan.dryRunDuplicateIdentityCount);
	setField(L, "dryRunMaxDepth", plan.dryRunMaxDepth);
	setField(L, "dryRunMicros", plan.dryRunMicros);
	setField(L, "dryRunError", plan.dryRunError);
	pushBoolean(L, plan.reconciliationEvaluated);
	lua_setfield(L, -2, "reconciliationEvaluated");
	pushBoolean(L, plan.reconciliationReady);
	lua_setfield(L, -2, "reconciliationReady");
	setField(L, "reconciliationCandidateRows", plan.reconciliationCandidateRows);
	setField(L, "reconciliationDecodedRows", plan.reconciliationDecodedRows);
	setField(L, "reconciliationInvalidRows", plan.reconciliationInvalidRows);
	setField(L, "reconciliationFalsePositiveRows", plan.reconciliationFalsePositiveRows);
	setField(L, "playerIdentityCount", plan.playerIdentityCount);
	setField(L, "playerUniqueIdentityCount", plan.playerUniqueIdentityCount);
	setField(L, "playerDuplicateIdentityCount", plan.playerDuplicateIdentityCount);
	setField(L, "inventoryIdentityCount", plan.inventoryIdentityCount);
	setField(L, "depotLockerIdentityCount", plan.depotLockerIdentityCount);
	setField(L, "depotIdentityCount", plan.depotIdentityCount);
	setField(L, "inboxIdentityCount", plan.inboxIdentityCount);
	setField(L, "storeInboxIdentityCount", plan.storeInboxIdentityCount);
	setField(L, "floorOnlyIdentityCount", plan.floorOnlyIdentityCount);
	setField(L, "floorPlayerIdentityMatchCount", plan.floorPlayerIdentityMatchCount);
	setField(L, "floorPlayerAmbiguousIdentityCount", plan.floorPlayerAmbiguousIdentityCount);
	setField(L, "reconciliationMicros", plan.reconciliationMicros);
	setField(L, "reconciliationError", plan.reconciliationError);
	setField(L, "reconciliationFirstMatch", plan.reconciliationFirstMatch);
	pushBoolean(L, plan.quarantineEvaluated);
	lua_setfield(L, -2, "quarantineEvaluated");
	pushBoolean(L, plan.quarantineReady);
	lua_setfield(L, -2, "quarantineReady");
	setField(L, "quarantinePlannedRows", plan.quarantinePlannedRows);
	setField(L, "quarantineStackableItemCount", plan.quarantineStackableItemCount);
	setField(L, "quarantinePlayerMatchItemCount", plan.quarantinePlayerMatchItemCount);
	setField(L, "quarantineSnapshotItemCount", plan.quarantineSnapshotItemCount);
	setField(L, "quarantineSerializedBytes", plan.quarantineSerializedBytes);
	setField(L, "quarantinePersistedRows", plan.quarantinePersistedRows);
	setField(L, "quarantinePersistedStackableItems", plan.quarantinePersistedStackableItems);
	setField(L, "quarantinePersistedPlayerMatches", plan.quarantinePersistedPlayerMatches);
	setField(L, "quarantinePersistedBytes", plan.quarantinePersistedBytes);
	setField(L, "quarantineMicros", plan.quarantineMicros);
	setField(L, "quarantineError", plan.quarantineError);
	pushBoolean(L, plan.applyEvaluated);
	lua_setfield(L, -2, "applyEvaluated");
	pushBoolean(L, plan.applyReady);
	lua_setfield(L, -2, "applyReady");
	pushBoolean(L, plan.applyCompleted);
	lua_setfield(L, -2, "applyCompleted");
	setField(L, "applyRows", plan.applyRows);
	setField(L, "applyTargetTiles", plan.applyTargetTiles);
	setField(L, "applyPolicyRestoreItemCount", plan.applyPolicyRestoreItemCount);
	setField(L, "applyPolicyRestoreTopItemCount", plan.applyPolicyRestoreTopItemCount);
	setField(L, "applyRestoredItemCount", plan.applyRestoredItemCount);
	setField(L, "applyRestoredTopItemCount", plan.applyRestoredTopItemCount);
	setField(L, "applyQuarantineItemCount", plan.applyQuarantineItemCount);
	setField(L, "applySuppressedItemCount", plan.applySuppressedItemCount);
	setField(L, "applySuppressedTopItemCount", plan.applySuppressedTopItemCount);
	setField(L, "applyDirectSuppressedIdentityCount", plan.applyDirectSuppressedIdentityCount);
	setField(L, "applyHeldDecayItemCount", g_game.getFloorRecoveryHeldDecayItemCount());
	setField(L, "applyMicros", plan.applyMicros);
	setField(L, "applyError", plan.applyError);
	pushBoolean(L, plan.confirmationEvaluated);
	lua_setfield(L, -2, "confirmationEvaluated");
	pushBoolean(L, plan.confirmationReady);
	lua_setfield(L, -2, "confirmationReady");
	pushBoolean(L, plan.confirmationCompleted);
	lua_setfield(L, -2, "confirmationCompleted");
	setField(L, "confirmationRecordId", plan.confirmationRecordId);
	setField(L, "confirmationSourceSessionId", plan.confirmationSourceSessionId);
	setField(L, "confirmationApplySessionId", plan.confirmationApplySessionId);
	setField(L, "confirmationPendingQuarantineRows", plan.confirmationPendingQuarantineRows);
	setField(L, "confirmationPendingQuarantineItems", plan.confirmationPendingQuarantineItems);
	setField(L, "confirmationPendingPlayerMatches", plan.confirmationPendingPlayerMatches);
	setField(L, "confirmationResumedDecayItemCount", g_game.getFloorRecoveryResumedDecayItemCount());
	setField(L, "confirmationExtendedPlayerCorpseCount", g_game.getFloorRecoveryExtendedPlayerCorpseCount());
	setField(L, "confirmationRemovedHeldDecayItemCount", g_game.getFloorRecoveryRemovedHeldDecayItemCount());
	setField(L, "confirmationMicros", plan.confirmationMicros);
	setField(L, "confirmationPlayerGuid", plan.confirmationPlayerGuid);
	setField(L, "confirmationConfirmedAt", plan.confirmationConfirmedAt);
	setField(L, "confirmationPlayerName", plan.confirmationPlayerName);
	setField(L, "confirmationError", plan.confirmationError);
	setField(L, "sourceStartedAt", plan.sourceStartedAt);
	setField(L, "sourceUpdatedAt", plan.sourceUpdatedAt);
	setField(L, "sourceCommittedAt", plan.sourceCommittedAt);
	return 1;
}

int LuaScriptInterface::luaGameApplyFloorRecovery(lua_State* L)
{
	// Game.applyFloorRecovery(expectedSourceSessionId)
	pushBoolean(L, g_game.applyFloorRecovery(getNumber<uint64_t>(L, 1)));
	return 1;
}

int LuaScriptInterface::luaGameConfirmFloorRecovery(lua_State* L)
{
	// Game.confirmFloorRecovery(expectedSourceSessionId, confirmerGuid, confirmerName)
	pushBoolean(L, g_game.confirmFloorRecovery(
		getNumber<uint64_t>(L, 1), getNumber<uint32_t>(L, 2), getString(L, 3)));
	return 1;
}

int LuaScriptInterface::luaGameVerifyFloorSnapshot(lua_State* L)
{
	// Game.verifyFloorSnapshot(position)
	const FloorSnapshotVerification result = g_game.verifyFloorSnapshot(getPosition(L, 1));
	lua_createtable(L, 0, 25);
#define SET_FLOOR_VERIFY_BOOL(field) pushBoolean(L, result.field); lua_setfield(L, -2, #field)
	SET_FLOOR_VERIFY_BOOL(rowFound);
	SET_FLOOR_VERIFY_BOOL(storedChecksumValid);
	SET_FLOOR_VERIFY_BOOL(storedBlobValid);
	SET_FLOOR_VERIFY_BOOL(liveSnapshotValid);
	SET_FLOOR_VERIFY_BOOL(matchesLive);
	SET_FLOOR_VERIFY_BOOL(dirty);
	SET_FLOOR_VERIFY_BOOL(inFlight);
#undef SET_FLOOR_VERIFY_BOOL
	setField(L, "dirtyTileVersion", result.dirtyTileVersion);
	setField(L, "storedTileVersion", result.storedTileVersion);
	setField(L, "storedItemCount", result.storedItemCount);
	setField(L, "storedTopItemCount", result.storedTopItemCount);
	setField(L, "storedBytes", result.storedBytes);
	setField(L, "liveItemCount", result.liveItemCount);
	setField(L, "liveTopItemCount", result.liveTopItemCount);
	setField(L, "liveBytes", result.liveBytes);
	setField(L, "storedPolicyVersion", result.storedPolicyVersion);
	setField(L, "storedUpdatedAt", result.storedUpdatedAt);
	setField(L, "storedChecksum", result.storedChecksum);
	setField(L, "liveChecksum", result.liveChecksum);
	setField(L, "error", result.error);
	return 1;
}

int LuaScriptInterface::luaGameInspectFloorInstanceId(lua_State* L)
{
	// Game.inspectFloorInstanceId(instanceId)
	const FloorInstanceLookup lookup = g_game.inspectFloorInstanceId(getString(L, 1));
	lua_createtable(L, 0, 9);
	setField(L, "validFormat", lookup.validFormat);
	setField(L, "databaseAvailable", lookup.databaseAvailable);
	setField(L, "safeToRecreate", lookup.safeToRecreate);
	setField(L, "databaseMatches", lookup.databaseMatches);
	setField(L, "liveMatches", lookup.liveMatches);
	setField(L, "firstDatabaseLocation", lookup.firstDatabaseLocation);
	setField(L, "firstLiveLocation", lookup.firstLiveLocation);
	setField(L, "error", lookup.error);
	return 1;
}

int LuaScriptInterface::luaGameFlushFloorSnapshots(lua_State* L)
{
	// Game.flushFloorSnapshots()
	lua_pushnumber(L, g_game.flushFloorSnapshots());
	return 1;
}

int LuaScriptInterface::luaGameSimulateFloorSnapshotFailures(lua_State* L)
{
	// Game.simulateFloorSnapshotFailures(count)
	const uint32_t count = std::min<uint32_t>(getNumber<uint32_t>(L, 1, 1), 100);
	g_game.simulateFloorSnapshotFailures(count);
	lua_pushnumber(L, count);
	return 1;
}

int LuaScriptInterface::luaGameBeginFloorPersistenceCleanSave(lua_State* L)
{
	// Game.beginFloorPersistenceCleanSave([resetFloorSnapshots = false])
	pushBoolean(L, g_game.beginFloorPersistenceCleanSave(getBoolean(L, 1, false)));
	return 1;
}

int LuaScriptInterface::luaGameActivateEmergency(lua_State* L)
{
	// Game.activateEmergency(activatorGuid, activatorName)
	const uint32_t activatorGuid = getNumber<uint32_t>(L, 1);
	const std::string activatorName = getString(L, 2);
	pushBoolean(L, g_game.activateEmergency(activatorGuid, activatorName));
	return 1;
}

int LuaScriptInterface::luaGameFinishEmergency(lua_State* L)
{
	// Game.finishEmergency(finisherGuid, finisherName)
	const uint32_t finisherGuid = getNumber<uint32_t>(L, 1);
	const std::string finisherName = getString(L, 2);
	pushBoolean(L, g_game.finishEmergency(finisherGuid, finisherName));
	return 1;
}

int LuaScriptInterface::luaGameIsEmergencyActive(lua_State* L)
{
	// Game.isEmergencyActive()
	pushBoolean(L, g_game.isEmergencyActive());
	return 1;
}

int LuaScriptInterface::luaGameGetSpawnPlayerBucket(lua_State* L)
{
	// Game.getSpawnPlayerBucket()
	lua_pushnumber(L, g_game.getSpawnPlayerBucket());
	return 1;
}

int LuaScriptInterface::luaGameIsSpawnPlayerBucketOverridden(lua_State* L)
{
	// Game.isSpawnPlayerBucketOverridden()
	pushBoolean(L, g_game.isSpawnPlayerBucketOverridden());
	return 1;
}

int LuaScriptInterface::luaGameSetSpawnPlayerBucketOverride(lua_State* L)
{
	// Game.setSpawnPlayerBucketOverride(playerBucket)
	pushBoolean(L, g_game.setSpawnPlayerBucketOverride(getNumber<int32_t>(L, 1)));
	return 1;
}

int LuaScriptInterface::luaGameClearSpawnPlayerBucketOverride(lua_State* L)
{
	// Game.clearSpawnPlayerBucketOverride()
	g_game.clearSpawnPlayerBucketOverride();
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaGameIsSpawnRateBoostActive(lua_State* L)
{
	// Game.isSpawnRateBoostActive()
	pushBoolean(L, g_game.isSpawnRateBoostActive());
	return 1;
}

int LuaScriptInterface::luaGameGetSpawnRateBoostRemainingSeconds(lua_State* L)
{
	// Game.getSpawnRateBoostRemainingSeconds()
	lua_pushnumber(L, g_game.getSpawnRateBoostRemainingSeconds());
	return 1;
}

int LuaScriptInterface::luaGameGetSpawnRateBoostExpiresAt(lua_State* L)
{
	// Game.getSpawnRateBoostExpiresAt()
	lua_pushnumber(L, g_game.getSpawnRateBoostExpiresAt());
	return 1;
}

int LuaScriptInterface::luaGameAddSpawnRateBoostDuration(lua_State* L)
{
	// Game.addSpawnRateBoostDuration(durationSeconds)
	pushBoolean(L, g_game.addSpawnRateBoostDuration(getNumber<uint32_t>(L, 1)));
	return 1;
}
...
int LuaScriptInterface::luaItemSetActionId(lua_State* L)
{
	...
	if (item) {
		item->setActionId(actionId);
		item->markFloorPersistenceAttributeDirty();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaItemRemoveAttribute(lua_State* L)
{
	...
	if (ret) {
		const bool existed = item->hasAttribute(attribute);
...
int LuaScriptInterface::luaItemRemoveCustomAttribute(lua_State* L) {
	...
	bool removed = false;
	if (isNumber(L, 2)) {
		removed = item->removeCustomAttribute(getNumber<int64_t>(L, 2));
		pushBoolean(L, removed);
	} else if (isString(L, 2)) {
		removed = item->removeCustomAttribute(getString(L, 2));
		pushBoolean(L, removed);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaItemGetLastActorGuid(lua_State* L)
{
	// item:getLastActorGuid()
	Item* item = getUserdata<Item>(L, 1);
	if (!item) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushnumber(L, item->getFloorPersistenceLastActorGuid());
	return 1;
}
...
int LuaScriptInterface::luaItemGetFloorPersistenceInstanceId(lua_State* L)
{
	// item:getFloorPersistenceInstanceId()
	Item* item = getUserdata<Item>(L, 1);
	if (!item) {
		lua_pushnil(L);
		return 1;
	...
	if (instanceId.empty()) {
		...
		pushString(L, instanceId);
	}
	return 1;
}

int LuaScriptInterface::luaItemEnsureFloorPersistenceInstanceId(lua_State* L)
{
	// item:ensureFloorPersistenceInstanceId()
	Item* item = getUserdata<Item>(L, 1);
	if (!item) {
		lua_pushnil(L);
		return 1;
	...
	if (!item->ensureFloorPersistenceInstanceId(instanceId)) {
		lua_pushnil(L);
	} else {
		pushString(L, instanceId);
	}
...
int LuaScriptInterface::luaItemEnsureFloorPersistenceSubtreeIdentified(lua_State* L)
{
	...
	pushBoolean(L, item->isFloorPersistenceSubtreeReady());
	return 1;
}
...
int LuaScriptInterface::luaPlayerGetCharmState(lua_State* L)
{
	// player:getCharmState(charmId)
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	const uint8_t charmId = getNumber<uint8_t>(L, 2);
	lua_pushnumber(L, static_cast<uint8_t>(player->getCharmState(charmId)));
	return 1;
}

int LuaScriptInterface::luaPlayerActivateCharm(lua_State* L)
{
	// player:activateCharm(charmId)
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	pushBoolean(L, player->activateCharm(getNumber<uint8_t>(L, 2)));
	return 1;
}

int LuaScriptInterface::luaPlayerSendCharmData(lua_State* L)
{
...
int LuaScriptInterface::luaPlayerStartPlayerShop(lua_State* L)
{
	// player:startPlayerShop()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		pushBoolean(L, g_playerShop.beginConfigure(player));
	} else {
		lua_pushnil(L);
	}
	return 1;
