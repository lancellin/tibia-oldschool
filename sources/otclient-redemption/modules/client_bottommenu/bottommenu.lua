...
function init()
    ...
    -- The login screen intentionally has no promotional/info strip at the bottom.
    -- Keep the widget loaded because entergame still supplies its optional data.
    bottomMenu:hide()
...
function show()
    -- Deliberately kept hidden on the login screen.
end
