...
local MAP_SHADERS = { {
    ...
    name = 'Map - Crisp AA Test',
    frag = 'shaders/fragment/crisp_aa_test.frag'
}, {
    name = 'Map - Crisp AA Strong',
    frag = 'shaders/fragment/crisp_aa_strong_test.frag'
}, {
    name = 'Map - Crisp AA Ultra',
    frag = 'shaders/fragment/crisp_aa_ultra_test.frag'
}, {
    name = 'Map - Crisp AA Clarity',
    frag = 'shaders/fragment/crisp_aa_clarity_test.frag'
}, {
    name = 'Map - Sepia',
...
local OUTFIT_SHADERS = { {
    ...
    name = 'Outfit - Loot Highlight',
    useFramebuffer = true,
    frag = 'shaders/fragment/loot_highlight.frag'
}, {
...
local function attachShaders()
    ...
    map:setShader('Map - Crisp AA Clarity')
