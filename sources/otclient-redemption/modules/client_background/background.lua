...
local backgroundParticlesEnabled = false
...
function init()
    ...
    if backgroundParticlesEnabled then
...
function startBackgroundEffectLoop()
    ...
    if not backgroundParticlesEnabled then
        local particlesWidget = background and background:getChildById('particles')
