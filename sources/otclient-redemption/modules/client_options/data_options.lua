return {
    ...
    enableHdSprites                   = {
        value = false,
        action = function(value, options, controller, panels, extraWidgets)
            g_sprites.setHdOverridesEnabled(value)
    ...
    enableHdFastPack                  = {
        value = false,
        action = function(value, options, controller, panels, extraWidgets)
            g_sprites.setHdFastPackEnabled(value)
    ...
    preloadAllSprites                 = {
        value = false,
        action = function(value, options, controller, panels, extraWidgets)
            g_sprites.setPreloadAllSpritesEnabled(value)
            g_things.setPreloadAllTexturesEnabled(value)

            if not value then
                g_sprites.clearPreloadedSprites()
                g_things.unloadTextures()
            end
        end
    },
