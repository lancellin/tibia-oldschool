...
if(isset($_GET['account']))
{
	...
	// Uniqueness is intentionally NOT checked here: answering whether an
	// account already exists would allow enumerating registered accounts.
	// Existence is verified only on form submit (system/pages/account/create.php).
...
else if(isset($_GET['email']))
{
	...
	// Uniqueness is intentionally NOT checked here (enumeration protection);
	// it is verified only on form submit (system/pages/account/create.php).
	success_(1);
}
