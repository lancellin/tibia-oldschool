...
mysqlPass = "123456"
mysqlDatabase = "oldschool772db_backup_test_20260610"
mysqlPort = 3306
mysqlSock = ""

-- Player login/logout database service
playerIoServiceEnabled = true
playerIoServiceHost = "127.0.0.1"
playerIoServicePort = 7180

-- Account authentication workers (separate from durable Player I/O)
authWorkerThreads = 2
...
floorPersistenceWorldId = 1
floorPersistenceGenerationId = 1
floorPersistenceSnapshotDebounceMs = 15000
floorPersistenceSnapshotMaxDelayMs = 60000
floorPersistenceSnapshotRetryMs = 5000
floorPersistenceSnapshotBatchSize = 32
...
experienceStages = {
	{ minlevel = 1, maxlevel = 8, multiplier = 30 },
	{ minlevel = 9, maxlevel = 20, multiplier = 30 },
	{ minlevel = 21, maxlevel = 50, multiplier = 30 },
	{ minlevel = 51, maxlevel = 100, multiplier = 30 },
	{ minlevel = 101, multiplier = 30 }
}
...
rateMagic = 20
rateSpawn = 1
-- Divides the dynamic respawn interval after the online-player bucket calculation.
rateSpawnTime = 2
-- Seconds between retries for a spawn whose normal respawn is blocked by a nearby player.
spawnBlockedRetryInterval = 10
...
-- Local load-test switch: NPCs remain available, but no monsters are created
-- from world spawns (neither at startup nor by later respawn checks).
disableMonsterSpawns = true
