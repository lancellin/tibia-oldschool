...
if not NpcSystem then
	...
	-- The words for requesting trade window. For more information look at the top of modules.lua
	...
	-- Talkdelay behavior. Keep responses immediate for smoother NPC interaction.
