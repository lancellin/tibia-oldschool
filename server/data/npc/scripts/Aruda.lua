...
if talk_state == 1 and msgcontains(msg, '') and npcHandler:isFocused(cid) then
	npcHandler:say("I would never have guessed that.", 1)
	talk_state = 0
elseif msgcontains(msg, '') and npcHandler:isFocused(cid) and getPlayerItemCount(cid,2148) <= 20 and getPlayerItemCount(cid,2152) <= 0 and getPlayerItemCount(cid,2160) <= 0 then
	npcHandler:say("Oh, I just remember I have some work to do, sorry. Bye!", 1)
	talk_state = 0
	npcHandler:releaseFocus()
	npcHandler:resetNpc()
elseif msgcontains(msg, '') and npcHandler:isFocused(cid) and getPlayerItemCount(cid,2148) <= 0 and getPlayerItemCount(cid,2152) <= 1 and getPlayerItemCount(cid,2160) <= 0 then
	npcHandler:say("Oh, I just remember I have some work to do, sorry. Bye!", 1)
	talk_state = 0
	npcHandler:releaseFocus()
	npcHandler:resetNpc()
elseif msgcontains(msg, '') and npcHandler:isFocused(cid) and getPlayerItemCount(cid,2148) <= 0 and getPlayerItemCount(cid,2152) <= 0 and getPlayerItemCount(cid,2160) <= 1 then
	npcHandler:say("Oh, I just remember I have some work to do, sorry. Bye!", 1)
	talk_state = 0
	npcHandler:releaseFocus()
	npcHandler:resetNpc()
	
elseif msgcontains(msg, 'how are you') and npcHandler:isFocused(cid) then
...
elseif msgcontains(msg, 'job') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'new') and npcHandler:isFocused(cid) then
	npcHandler:say("You should ask Oswald about news. He loves them.", 1)
	talk_state = 0

elseif msgcontains(msg, 'name') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'aruda') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'time') and npcHandler:isFocused(cid) then
...
elseif msgcontains(msg, 'help') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'monster') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'dungeon') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'sewer') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'god') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'king') and npcHandler:isFocused(cid) then
...
elseif msgcontains(msg, 'sam') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'benjamin') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'gorn') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'quentin') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'bozo') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'oswald') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'rumour') and npcHandler:isFocused(cid) or msgcontains(msg, 'rumor') and npcHandler:isFocused(cid) or msgcontains(msg, 'gossip') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'fuck') and npcHandler:isFocused(cid) then
...
elseif msgcontains(msg, 'kiss') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 20) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'weapon') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'magic') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'thief') and npcHandler:isFocused(cid) or msgcontains(msg, 'theft') and npcHandler:isFocused(cid) then
	npcHandler:say("Oh, sorry, I have to hurry, bye!", 1)
	talk_state = 0	
	npcHandler:releaseFocus()
	npcHandler:resetNpc()
	
elseif msgcontains(msg, 'tibia') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'castle') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'muriel') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'elane') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'marvik') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'gregor') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'noodles') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'dog') and npcHandler:isFocused(cid) or msgcontains(msg, 'poodle') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 5) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'excalibug') and npcHandler:isFocused(cid) then
	if CHANCE <= PROCENT and doPlayerRemoveMoney(cid, 10) then
	npcHandler:say("Oh, sorry, I was distracted, what did you say?", 1)
	talk_state = 0
	else
...
elseif msgcontains(msg, 'partos') and npcHandler:isFocused(cid) then
	npcHandler:say("I ... don't know someone named like that.", 1)
	talk_state = 4	

elseif talk_state == 4 and msgcontains(msg, 'spouse') and npcHandler:isFocused(cid) or talk_state == 4 and msgcontains(msg, 'girlfriend') and npcHandler:isFocused(cid) then
	npcHandler:say("Well ... I  might have known him a little .. but there was nothing serious.", 1)
	talk_state = 5	

elseif talk_state == 5 and msgcontains(msg, 'fruit') and npcHandler:isFocused(cid) then
	npcHandler:say("I remember that grapes were his favourites. He was almost addicted to them.", 1)
	talk_state = 0	

elseif msgcontains(msg, 'yenny') and npcHandler:isFocused(cid) then
