...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'yes') and npcHandler.topic[cid] == 1 and getPlayerItemCount(cid,2559) >= 1 then
	npcHandler:say('Splendid! Here take your pickaxe.', cid)
	doPlayerRemoveItem(cid,2559,1)
	doPlayerAddItem(cid,2553,1)
	npcHandler.topic[cid] = 0
	elseif msgcontains(msg, 'yes') and npcHandler.topic[cid] == 1 and getPlayerItemCount(cid,2559) == 0 then
