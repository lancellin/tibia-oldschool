...
local function addTravelKeyword(keyword, cost, destination, action)
	local travelKeyword = keywordHandler:addKeyword({keyword}, StdModule.say, {npcHandler = npcHandler, text = 'Do you want a round-trip passage to ' .. titleCase(keyword) .. ' for ' .. cost .. ' gold?', cost = cost})
