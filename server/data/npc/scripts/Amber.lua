...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'yes') and npcHandler.topic[cid] == 1 and getPlayerItemCount(cid,1955) >= 1 then
	...
	elseif msgcontains(msg, 'yes') and npcHandler.topic[cid] == 1 and getPlayerItemCount(cid,1955) == 0 then
	...
	elseif msgcontains(msg, 'yes') and npcHandler.topic[cid] == 3 and getPlayerItemCount(cid,2668) >= 1 then
	npcHandler:say('Thank you. Orcs call arrows \'pixo\'.', cid)
	doPlayerRemoveItem(cid,2668,1)
	npcHandler.topic[cid] = 0
	elseif msgcontains(msg, 'yes') and npcHandler.topic[cid] == 3 and getPlayerItemCount(cid,2668) == 0 then
	npcHandler:say('You don\'t have one!', cid)
	npcHandler.topic[cid] = 0
	
	elseif msgcontains(msg, 'bye') and npcHandler.topic[cid] >= 1 and npcHandler.topic[cid] <= 3 then
