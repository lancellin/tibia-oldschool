...
local function addTravelKeyword(keyword, cost, destination, action)
	local travelKeyword = keywordHandler:addKeyword({keyword}, StdModule.say, {npcHandler = npcHandler, text = 'So you want to go to Cormaya for ' .. cost .. ' gold?', cost = cost, discount = 'postman'})
