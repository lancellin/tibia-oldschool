...
function onCreatureSay(cid, type, msg)
	if not npcHandler:isFocused(cid) and (msgcontains(msg, 'hi king') or msgcontains(msg, 'hello king') or msgcontains(msg, 'hail king') or msgcontains(msg, 'hail the king')) then
