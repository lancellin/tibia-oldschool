...
if msgcontains(msg, 'hi maryza') and npcHandler:isFocused(cid) or msgcontains(msg, 'hello maryza') and npcHandler:isFocused(cid) then
npcHandler:say("Come back if you enjoyed my tavern, if not ... well, get eaten by a dragon, jawoll.", 1)
npcHandler:releaseFocus()
npcHandler:resetNpc()

elseif msgcontains(msg, 'maryza') and npcHandler:isFocused(cid) then
