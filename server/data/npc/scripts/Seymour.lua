...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'yes') and npcHandler.topic[cid] == 1 and getPlayerMoney(cid) >= 5 then
	...
	elseif msgcontains(msg, 'yes') and npcHandler.topic[cid] == 2 and getPlayerItemCount(cid,1990) >= 1 then
	...
	npcHandler.topic[cid] = 0
	elseif msgcontains(msg, 'yes') and npcHandler.topic[cid] == 2 and getPlayerItemCount(cid,1990) == 0 then
