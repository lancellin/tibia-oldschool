...
function onCreatureSay(cid, type, msg)
	if not npcHandler:isFocused(cid) and (msgcontains(msg, 'hi queen') or msgcontains(msg, 'hello queen') or msgcontains(msg, 'hail queen') or msgcontains(msg, 'salutations')) then
