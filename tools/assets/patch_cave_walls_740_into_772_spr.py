...
# Wall mappings come from the original 7.4 DAT. CID 386 -> 530 is intentional.
CLIENT_TO_SOURCE = {
    356: 467,
    357: 471,
    358: 473,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Replace existing 772 cave-wall slots with selected original 740 payloads."
    )
